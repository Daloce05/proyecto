<template>
  <div class="p-6 space-y-4">
    ...
    <h1 class="text-2xl font-bold">Crear médico</h1>
...
const form = ref({ name: '', email: '', specialty: 'Neumología' })
function submit() { router.post(route('panel.doctors.store'), form.value) }
</script>
